...
const OPERATOR_NAV: NavItem[] = [
  ...
  },
  {
    ...
    submenu: [
      ...
      { label: "Proof Packs", href: "/compliance?tab=proofs", testId: "nav-cp-proofs" },
      { label: "Verification", href: "/compliance?tab=anchoring", testId: "nav-cp-anchoring" },
      { label: "Trade Passport", href: "/compliance?tab=passport", testId: "nav-cp-passport" },
      { label: "Track & Trace", href: "/compliance?tab=track-trace", testId: "nav-cp-track" },
    ],
  },
  {
